...
class ImagePreprocessor:
    ...
    def __init__(self, loader, quantizer):
        ...
        self.all_formats = ["fp32", "fp32_nomean", "int8_linear", "int8_chw4", "fp32_pytorch"]
    ...
    def convert(self, image_list):
        ...
        for idx, img_file in enumerate(image_list):
            ...
            if "fp32_pytorch" in self.run_formats:
                np.save(self.get_out_fpath("fp32_pytorch", img_file), image_fp32)
